...
all: demo.o DisplayUtility.o Person.o Employee.o
	$(CXX) $(CXXFLAGS) -o $(EXE) demo.o DisplayUtility.o Person.o Employee.o

demo.o: demo.cpp DisplayUtility.o Person.o Employee.o
